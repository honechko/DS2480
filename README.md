...
This device is based on DS2480B, UART to 1-wire bus master converter. Device is
fully compatible with a lot of software written for DS2480B (such as [OWFS](https://github.com/owfs/owfs)).
